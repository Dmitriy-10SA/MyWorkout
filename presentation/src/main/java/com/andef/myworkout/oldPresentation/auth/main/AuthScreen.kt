...
import com.andef.myworkout.oldPresentation.auth.main.content.ForgotPasswordDialog
import com.andef.myworkout.oldPresentation.auth.main.content.LoginContent
import com.andef.myworkout.oldPresentation.auth.main.content.OldAuthScreenTemplate
import com.andef.myworkout.oldPresentation.auth.main.content.SignUpContent
    ...
    UiScaffold(
        ...
        if (!state.value.isCheckTokenLoading && !state.value.isSwitchToMainScreen) {
            when (showEmptyAuthScreenTemplate.value) {
                true -> {
                    OldAuthScreenTemplate(paddingValues = paddingValues)
